...
//    LoginDBAdapter loginDBAdapter;
    ...
    public NotifTabFollowingRVAdapter(List<Notif> user, Context context) {
        this.user = user;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        /*if((_user.getType().equals("like") || _user.getType().equals("comment")) *//*&& (loginDBAdapter.getIDUserPosting(_user.id_post) == loginDBAdapter.getID(userName) || _user.user_id == loginDBAdapter.getIDUserPosting(_user.id_post)*//*) {
           ...
           /* if (_user.getType().equals("follow") *//*&& loginDBAdapter.getUserName(_user.user_id).equals(userName)*//*)
                _holder.content.setText(" are following " + loginDBAdapter.getUserName(_user.following));*/
            /*else if (_user.getType().equals("follow")*//* && loginDBAdapter.getUserName(_user.following).equals(userName)*//*)
                _holder.content.setText(" started following you");*/
            /*else */if (_user.getType().equals("follow"))
                _holder.content.setText(" started following " + _user.getToUserName());
            else if (_user.getType().equals("like")) {
                _holder.content.setText(" liked " + _user.getToUserName() + "'s post");
