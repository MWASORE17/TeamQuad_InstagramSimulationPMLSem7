...
<div class="page-wrapper">	
	<div class="row">
		<div class="col-md-12">
			<?=form_open('task/laporan',array('target'=>'_blank', 'id' => 'validate'))?>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4">
						...
						<div class="input-group">
					        ...
					        <input style="" readonly="" data-date="" data-date-format="yyyy-mm-dd" id="dp1356593248900" class="StartDate form-control date-picker date1" type="text" value="" name="FromDate" >
					    	<span class="add-on input-group-btn">
					...
					<div class="col-md-4 col-sm-4">
						...
						<!-- <input id="UntilDate" type="text" size="30" style="width: 30%" class="required datepicker" name="UntilDate" value=""  /> -->
						<div class="input-group">
					        <span class="add-on input-group-btn">
				                <button disabled type="button" class="btn btn-default tanggal">
				                    <span class="glyphicon glyphicon-calendar "></span>
					        ...
					        <input style="" readonly="" data-date="" data-date-format="yyyy-mm-dd" id="dp1356593248900" class="endDate form-control date-picker date2" type="text" value="" name="UntilDate" >
					    	<span class="add-on input-group-btn">
